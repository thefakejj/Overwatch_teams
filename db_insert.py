...
def insert_into_people(name, status, country_id, user_id):
    sql = text('''
        INSERT INTO people (name, status, country_id, user_id)
        VALUES (:name, :status, :country_id, :user_id)
    ''')
...
def insert_into_people_teams_roles(person_id, player_team, coach_team, manager_team):
    ...
    sql = text('''
        ...
        VALUES (:person_id, :player_team, :coach_team, :manager_team)
    ''')
...
def insert_into_in_game_roles(person_id, damage, tank, support):
    sql = text('''
        ...
        VALUES (:person_id, :damage, :tank, :support)
    ''')
